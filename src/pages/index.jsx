...
const LandingPage = () => {
  ...
  useEffect(() => {
    setShowSuccess(router.asPath.includes('connected=true'))
  }, [router.asPath])
  ...
  return (
    <>
      <Head>
        <title>VibeVault: Accurate Spotify Stats, Top Artists, and Charts</title>
        <meta
          name="description"
          content="VibeVault delivers accurate Spotify stats, top artists, and charts so you can understand your listening habits instantly."
        />
        <link rel="icon" href="/vibevault.svg" />
      </Head>
      <div className="min-h-screen bg-slate-950 text-slate-100">
        ...
        <main className="max-w-6xl mx-auto px-6 py-16 grid gap-12 lg:grid-cols-[1.1fr,0.9fr] items-center">
          <div>
            <span className="inline-flex items-center text-xs tracking-widest uppercase text-vault-accent bg-vault-muted/60 px-3 py-1 rounded-full mb-6">
              High-Intent Listening Insights
            </span>
